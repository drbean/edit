...
The implication is that the participants were able to see the barrier somewhat adequately with the lighting generated by the LED lights on the cameras. The illuminance of this lighting on the walkway was lower than that (0.22 to 0.93 lx) recommended in the literature (Fotios and Uttley, 2018). There were no conflicts between the results of the two studies because Fotios and Uttley (2018) did not test the illuminance below 0.2 lx. Therefore, our findings provide supplemental information to that in the literature. A person may gain benefits from dim lighting (<0.01 lx) on the walkway when he or she is approaching a barrier.
