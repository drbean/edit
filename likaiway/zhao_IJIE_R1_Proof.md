...
barrier than when the barrier was a board. The finding from the earlier study (Li et al., 2019b) was based only on visual observation by the research personnel. The current study confirms the result using kinematic data for the feet. This confirmation provides scientific evidence that the motion of the foot upon barrier crossing is affected by the type of barrier. This implies that the participants adopted different gait strategies to control foot movement when they were about to engage different types of barrier. 
